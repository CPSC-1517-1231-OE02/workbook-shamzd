...
namespace Hockey.Test
{
    ...
    {
        //Const for testing hockey team
        const string City = "Fake City";
        const string TeamName = "Fakers";

        //Const for test hockey player, This is the same as the hockey player test except for a few taken off like age and ToString() value
        ...
        //this reflects the const for the hockey player up top to create a test for the hockey players
