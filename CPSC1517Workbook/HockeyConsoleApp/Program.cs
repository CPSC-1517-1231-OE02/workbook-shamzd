...
Console.WriteLine(player3);//Want to write player 3 to console. It uses the ToString method in the hockeyPlayer class to convert the object player3 to a string
